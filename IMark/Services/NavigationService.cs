    ...
    public class NavigationService : INavigationService
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            if (Settings.IsWalkthroughCompleted == true)
            {
                ...
                if (!string.IsNullOrEmpty(SettingExtension.AccessToken))
                {
        ...
        private void CreatePageViewModelMappings()
        {
            ...
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(CategoryPageViewModel), typeof(CategoryPage), false));
            ...
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(ShippingConfirmationViewModel), typeof(ShippingConfirmation), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(ShippingDetailsViewModel), typeof(ShippingDetails), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(PartnerBrandsViewModel), typeof(PartnerBrands), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(OurContributionViewModel), typeof(OurContribution), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(PhotoGalleryViewModel), typeof(PhotoGallery), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(FeaturesProductsViewModel), typeof(FeaturesProducts), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(AddPhotoViewModel), typeof(AddPhoto), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(AddPhoto2ViewModel), typeof(AddPhoto2), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(BecomeDistributorViewModel), typeof(BecomeDistributor), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(BecomeDistributor2ViewModel), typeof(BecomeDistributor2), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(FavoritesPageViewModel), typeof(FavoritesPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(NotificationPageViewModel), typeof(NotificationPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(SearchPageViewModel), typeof(SeachPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(CatagoriesByListViewModel), typeof(CatagoriesByList), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(CatagoriesTapListViewModel), typeof(CatagoriesTapList), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(UpdateAddressPageViewModel), typeof(UpdateAddressPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(ForgetPasswordPageViewModel), typeof(ForgetPasswordPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(CollectionByListViewModel), typeof(CollectionByList), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(SortPageViewModel), typeof(SortPage), false));
            _mappings.Add(new Tuple<Type, Type, bool>(typeof(DesignLabViewModel), typeof(DesignLab), false));
            ////PopupViews
